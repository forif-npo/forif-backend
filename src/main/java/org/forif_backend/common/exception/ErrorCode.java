...
public enum ErrorCode {
    ...
    MENTOR_CONFIRMATION_NOT_AVAILABLE(HttpStatus.BAD_REQUEST, "FOR131-400", "멘토 확인서는 종료된 승인 스터디에 대해서만 발급할 수 있습니다."),
    MENTOR_CONFIRMATION_INVALID_ACTIVITY_PERIOD(HttpStatus.BAD_REQUEST, "FOR132-400", "활동 시작일은 종료일보다 늦을 수 없습니다."),
