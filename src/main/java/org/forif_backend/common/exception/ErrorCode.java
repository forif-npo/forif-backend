...
public enum ErrorCode {
    ...
    AUTONOMOUS_STUDY_APPLY_CONFLICT(HttpStatus.BAD_REQUEST, "FOR140-400", "자율부원과 정규스터디는 중복 신청할 수 없습니다."),
    AUTONOMOUS_STUDY_APPLICATION_UPDATE_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "FOR142-400", "자율부원 신청서는 수정할 수 없습니다."),
    AUTONOMOUS_STUDY_APPLICATION_DECISION_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "FOR143-400", "자율부원 신청은 운영진이 처리합니다."),
    ...
    MENTOR_CONFIRMATION_NOT_AVAILABLE(HttpStatus.BAD_REQUEST, "FOR134-400", "멘토 확인서는 종료된 승인 스터디에 대해서만 발급할 수 있습니다."),
    MENTOR_CONFIRMATION_INVALID_ACTIVITY_PERIOD(HttpStatus.BAD_REQUEST, "FOR135-400", "활동 시작일은 종료일보다 늦을 수 없습니다."),
    MENTOR_CONFIRMATION_INVALID_ACTIVITY_PERIOD_FORMAT(HttpStatus.BAD_REQUEST, "FOR136-400", "활동 기간은 yyyy.MM.dd.~yyyy.MM.dd. 형식이어야 합니다."),
    ...
    AUTONOMOUS_STUDY_OPERATION_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "FOR132-400", "자율부원은 출석 체크 및 수료증 발급 대상이 아닙니다."),
    AUTONOMOUS_STUDY_NAME_NOT_CHANGEABLE(HttpStatus.BAD_REQUEST, "FOR133-400", "자율부원 등록용 스터디의 이름은 변경할 수 없습니다."),
    AUTONOMOUS_STUDY_NAME_RESERVED(HttpStatus.BAD_REQUEST, "FOR137-400", "자율부원 등록용 스터디의 명칭은 일반 스터디에 사용할 수 없습니다."),
    AUTONOMOUS_STUDY_APPLICATION_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "FOR139-400", "자율부원은 개설 신청서 조회 및 수정 대상이 아닙니다."),
    ...
    PRODUCT_STATUS_NOT_CHANGEABLE(HttpStatus.BAD_REQUEST, "FOR114-400", "승인된 서비스의 운영 상태만 변경할 수 있습니다."),
