...
public enum ErrorCode {
    ...
    WAITLIST_ORDER_REQUIRED(HttpStatus.BAD_REQUEST, "FOR010-400", "예비 상태일 경우 예비 순번을 입력해야 합니다."),
    APPLY_NOT_ACCEPTED_STATUS(HttpStatus.BAD_REQUEST, "FOR011-400", "합격 상태가 아닌 신청서입니다."),
