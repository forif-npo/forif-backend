...
-- hackathon_id=1 is the sole modeled event (2026-1) and represents the 17th
-- historical event. Preserve the real cumulative round before enforcing the
-- global unique constraint. The next created event will receive 18.
...
ALTER TABLE tb_hackathon_team
    ADD COLUMN competition_type VARCHAR(20) NOT NULL DEFAULT 'HACKATHON' AFTER description;
